...
** *returns*: Liste von Card Objekten.

==== /api/cards/{id}
* *GET*: Gibt die Karte zurück
** *returns*: Card JSON-Objekt der Karte.
...
** *body*: QuestionBase Objekt mit den gewünschten Daten für die Multiple Choice Frage
** *path variable*: ID der zu ändernden Multiple Choie Frage 
** *returns*: QuestionResponse Objekt der aktualisierten Frage
...
** *returns*: LearningSet JSON-Objekt
