...
| HTW-Mitglied 
| Person, die an der HTW Dresden tätig oder immatrikuliert ist	
| Name: String, Vorname: String, Rolle: Enum	
| Benutzername und Passwort erforderlich, Rolle muss definiert sein	
| Benutzer, User, Person

| Studierender
| Spezialisierung von HTW-Mitglied: Studierender, der Lernsets nutzt und erstellt	
| Benutzername: String, Passwort: String, Rolle: Enum
| Passwort muss muss mind. ein Sonderzeichen beinhalten 
| Student, Lernender

| Lernset	
| Sammlung von Fragen zu einem Modul mit zugeordnetem Lernmodus	
| Titel: String, LernsetID: Int, Beschreibung: String	Titel: String
| LernsetID muss eindeutig sein, Titel erforderlich, Mindestens 1 Frage muss enthalten sein	
| Fragenkatalog

| Frage	
| Einzelne Lernfrage innerhalb eines Lernsets	
| FrageID: Int, Fragetext: String 
| FrageID muss eindeutig sein, Fragetext muss ausgefüllt sein, Muss 1-4 Antworten enthalten
| Aufgabe

| Antwort	
| Antwortmöglichkeit zu einer Frage	
| Antworttext: String, Lösung: Boolean	
| Antworttext erforderlich, Lösung = true, false, Mind. 1 Antwort pro Frage muss Lösung=true haben	
| Antwortoption, Response

| Lernmodus	
| Definiert die Art der Visualisierung eines Lernsets	
| Enum-Verweis auf Visualisierungstyp	
| Muss einem der definierten Visualisierungstypen entsprechen	
| Darstellungsform
