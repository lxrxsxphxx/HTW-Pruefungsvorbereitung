...
// ist die Abkürzung IT notwendig?
[%header]
|===
...
| IT | Informationstechnik | Ein Fachbereich, der sich mit der Verarbeitung und Übertragung von Informationen befasst.
|===
...
image::requirements/images/Uml-Diagram.png[height=600, title="Domänenmodell"] 