...
Möchte, dass das System effiziente Lernmethoden unterstützt, z.B. durch kurze interaktive Lernmodule und Gamification-Elemente, um Motivation und Spaß zu fördern.

*Hindernisse/Frustrationen:*

Wäre frustriert, wenn das System zu monoton ist oder zu lange Lernabschnitte bietet, da dies ihr effizientes Lernen behindert. Außerdem könnte mangelnde Datenschutzsicherheit ihr Vertrauen beeinträchtigen.
...
Braucht eine klare Strukturierung der Lerninhalte, die das System einfach zugänglich macht und komplexe Themen verständlich erklärt. Funktion wie personalisierte Lernpfade oder gezielte Prüfungsfragen wären wichtig.

*Hindernisse/Frustrationen:*

Verliert die Motivation, wenn das System ihn mit zu vielen oder irrelevanten Inhalten überfordert oder die Navigation unübersichtlich ist.
...
Erwartet, dass die bereitgestellten Inhalte schnell und unkompliziert eingepflegt werden können, um Studierende effizient zu prüfen.
...
Erwartet eine möglichst einfache, wartbare Systemlösung, die während des Projekts stabil läuft und keine komplexen administrativen Eingriffe erfordert.

*Hindernisse/Frustrationen:*

Mögliche Unsicherheit bezüglich der Systemstabilität.
...
Eine praktikable Lösung bietet, die Studierende und Dozierende im Prüfungsprozess unterstützt, ohne großen Administrationsaufwand zu verursachen.

*Hindernisse/Frustrationen:*

Begrenzte Zeit und Ressourcen können die Vollständigkeit und langfristige Integration einschränken; zudem Bedenken, ob das Projekt tatsächlich den Anforderungen aller Nutzer gerecht wird.
