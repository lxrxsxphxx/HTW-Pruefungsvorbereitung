...
Möchte kurze, interaktive Lernmodule, die effizientes Lernen fördern

Erwartet Gamification-Elemente als Motivation

Will nicht durch lange Lerneinheiten gebremst werden

*Hindernisse/Frustrationen:*

Frustriert, wenn Lernmodule monoton oder zu lang sind

Misstraut, wenn das System keine ausreichende Datenschutzsicherheit bietet

=== 2. Studierende: Max König
[%hardbreaks]
...
Nutzerfreundliche Strukturierung der Lerninhalte

Personalisierte Lernpfade und gezielte Prüfungsfragen

Verständnis komplexer Zusammenhänge erleichtern

*Hindernisse/Frustrationen:*

Verliert Motivation bei irrelevanten Inhalten und unübersichtlicher Navigation


=== 3.Dozierende: Prof. Dr. Klaus Becker
[%hardbreaks]
...
Inhalte schnell und unkompliziert einpflegen

Effiziente Prüfungsdurchführung ermöglichen

*Hindernisse/Frustrationen:*

Zeitaufwand für Erstellung und Pflege von Lernmaterialien

Skepsis gegenüber Qualität von Community-Inhalten



=== 4.Tutor:in / Assistierende: Anna Schmidt
[%hardbreaks]
...
Effektive Unterstützung der Studierenden bei Prüfungsvorbereitung
...
Einfache, wartbare Systemlösung ohne komplexe Eingriffe

Stabilität im laufenden Betrieb

*Hindernisse/Frustrationen:*

Unsicherheit bezüglich Systemstabilität

=== 6.HTW (Institution): Dr. Petra Wagner
//Interesse an Noten:
...
Praktikable Lösung für Prüfungsprozess mit geringem Administrationsaufwand
