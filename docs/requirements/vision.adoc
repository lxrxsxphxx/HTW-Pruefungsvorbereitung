...
| Strukturierte Prüfungsvorbereitung | Hoch | Modulspezifische Fragenkataloge, Multiple-Choice-Verfahren, Freitextantworten mit automatischer Bewertung, Zuordnungsaufgaben mit Drag-and-Drop-Funktionalität | Version 1.0 
| Kollaboratives Lernen | Mittel | Benutzer-generierte Fragen mit Upload-Funktion, Community-basierte Bewertung von Fragenqualität (1-5 Sterne), Lerngruppen mit Chat-Funktionalität, moderierte Diskussionsforen pro Modul | Version 1.2 
| Adaptiver Lernalgorithmus | Hoch | Spaced-Repetition-System basierend auf Ebbinghaus-Vergessenskurve, automatische Wiederholung schwieriger Inhalte nach 1, 3, 7 und 14 Tagen, personalisierte Lernpfade basierend auf individuellen Schwächen | Version 1.0 
| Motivation durch Gamification | Hoch | Abzeichen-System für erreichte Meilensteine (Bronze/Silber/Gold), Highscore-Listen pro Modul und Semester, Levelsystem mit Erfahrungspunkten für korrekte Antworten, semesterweite Wettbewerbe mit Ranglisten | Version 1.1 
| Lernfortschritt-Tracking | Hoch | Detaillierte Statistiken über Antwortgenauigkeit, Schwächenanalyse mit Empfehlungen für Vertiefung, visuelle Darstellung des Fortschritts durch Diagramme und Heatmaps, Export-Funktion für persönliche Lernberichte | Version 1.0 
| Flexibles Lernen | Mittel | Offline-Modus mit Synchronisation bei Internetverbindung, responsive Design für mobile Endgeräte, Progressive Web App (PWA) für App-ähnliche Nutzung | Version 1.3 
| Verknüpfung mit offiziellen Lehrmaterialien | Mittel | Direkte Verlinkung zu HTW-Skripten im Moodle-System, Integration von Vorlesungsunterlagen als PDF-Viewer, Literaturverweise mit ISBN-Nummern und Bibliothekslinks | Version 1.2 
| Dozierenden-Bereich | Mittel | Erstellung und Verwaltung von Probeklausuren, Veröffentlichung modulspezifischer Inhalte, Moderationstools für Community-Beiträge, Einsicht in Lernstatistiken der Studierenden | Version 1.4 
|===
...
| Webbasierte Lösung (mobil und Desktop) | Hoch | Version 1.0 
| Kompatibilität mit HTW-Login und Authentifizierung (Single Sign-On) | Hoch | Version 1.0 
| Datensicherheit nach Datenschutz-Grundverordnung (DSGVO) | Hoch | Version 1.0 
| Benutzerfreundliches Interface mit Barrierefreiheit (WCAG 2.1) | Hoch | Version 1.0 
| Skalierbarkeit für neue Module und Studiengänge | Mittel | Version 1.1 
| Administrator-Dashboard zur Benutzer- und Inhaltsverwaltung | Mittel | Version 1.1 
| Umfassende Dokumentation und technischer Support | Mittel | Version 1.0 
| Application Programming Interface (API) für Drittanbieter-Integration | Niedrig | Version 2.0 
| Mehrsprachige Unterstützung (Deutsch/Englisch) | Niedrig | Version 1.5 
|===
