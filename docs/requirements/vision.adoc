...
|Studeneten
|Hauptnueri:innen der Anwendung. Effektive und motievierende Prüfungsvorbereitung, Nutzung verschiedener Lernmodi, eigene Fragen hochladen & beantworten. 
|Verfolgen des Lernfortschritts, Nutzung der App-Funktion, Beteiligung an der Community durch Fragen und Bewertungen

|Professor:in
|Verantwortlich für modulspezifische Inhalte. Validierung prüfungsrelevanter Fragen,Lernempfelungen, Probeklausuren, Rechtvergabe.
|Bereitstellung und Kontrolle von Inhalten, Betreuung der Studierenden, Auswertung von Lernfortschritten.

|HTW (Institution)
|Strategischer und organisatorischer Träger. Zuständig für Datenschutz, Infrastruktur, rechtliche Rahmenbedingung und Systemintegration.
