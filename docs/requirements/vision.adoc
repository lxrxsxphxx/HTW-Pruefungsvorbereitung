...
| Assistierende
| Studentische Hilfskräfte oder (wissenschaftliche) Mitarbeitende
...
| Admin
| Verantwortlicher für Betrieb, Sicherheit und Nutzerverwaltung des Systems
| Wartet das System, kann Benutzerrechte vergeben / entziehen. Sorgt für Datenkonsistenz und technische Stabilität.
