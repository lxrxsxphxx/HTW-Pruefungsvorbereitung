...
=== Vorbereitung
Seit dem Einbauen der Loginfunktion muss ein Nutzer sich erst einloggen, bevor er mit den anderen Endpunkten interagieren kann. Damit die bisherigen Integrationstests also funktionieren muss álso gewährleistet werden, dass der Cookie, der einen eingeloggten Nutzer identifiziert, im Client vorhaben ist.
